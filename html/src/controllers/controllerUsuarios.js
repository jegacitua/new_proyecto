app.controller('controllerUsuarios', ['$scope', 'serviceUploadFile', '$http', '$localStorage', '$location', '$state', '$timeout',function($scope, 
									serviceUploadFile,
									$http,
									$localStorage, 
									$location,
...
$('body').addClass('waitMe_body');
		...
		setTimeout(function(){ 
			...
			$http.post('src/models/login.class.php',{ accion 		: 'sesion_usuario', pagina : 'Usuarios'})
